...
export const metadata={ title: "Request A Sample" }
export default function Page(){
  return (
    <div className="mx-auto max-w-[1000px] px-6 py-20">
      <h1 className="text-4xl font-bold">Request A Sample</h1>
      <div className="mt-8 grid md:grid-cols-2 gap-6">
        ...
        <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&q=80" alt="Request A Sample demo" className="rounded-2xl aspect-[4/3] object-cover" />
      </div>
    </div>
  )
}
